...
This extension is a port of the Locus app ([website](https://getlocusapp.netlify.app/)) that was created for MacOS. 
...
3. Unzip the file.
4. Go to chrome://extensions and press the developer mode toggle in the right corner.
5. Press "Load unpacked" button in the top left and select the unziped file you just downloaded.

## Demo
Here's a demo video:
[Youtube Video Link](https://www.youtube.com/watch?v=6vvEqt25gpo)